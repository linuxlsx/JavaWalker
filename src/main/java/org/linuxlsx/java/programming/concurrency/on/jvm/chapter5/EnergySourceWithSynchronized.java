 ...
 * @date 2019/11/11
 */
public class EnergySourceWithSynchronized {
    ...
    private EnergySourceWithSynchronized() {
     ...
     * @return
     */
    public static EnergySourceWithSynchronized create() {
        final EnergySourceWithSynchronized source = new EnergySourceWithSynchronized();
        source.init();
        return source;
    }
